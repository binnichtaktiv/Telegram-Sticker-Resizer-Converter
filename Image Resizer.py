...
source_folder = input("Enter folder path with all your images that you want to resize:\n")
target_folder = input("Enter output path\n")

edited_folder_path = os.path.join(target_folder, 'edited')
...
for file_name in os.listdir(source_folder):
    if file_name.lower().endswith(('.png', '.jpg', '.jpeg', '.bmp', '.gif', '.tiff')):
        ...
        target_path = os.path.join(edited_folder_path, target_file_name)
